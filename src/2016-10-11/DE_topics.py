...
def _topics(res=''):
    ...
    data_train, train_label=pos[:cut_pos]+neg[:cut_pos],['pos']*cut_pos + ['neg']*cut_neg
    data_test, test_label = pos[cut_pos:]+neg[cut_pos:], ['pos']*(len(pos)-cut_pos) + ['neg']*(len(neg)-cut_neg)
